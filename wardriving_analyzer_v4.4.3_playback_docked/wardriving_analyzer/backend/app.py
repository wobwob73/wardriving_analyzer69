#!/usr/bin/env python3
"""
Wardriving Analyzer - Flask Backend with Embedded Frontend
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Wardriving Analyzer</title>
    ...
    <div class="app-container">
        ...
        <header class="header">
            <div class="header-left">
                ...
                <h1>Multi-Spectrum RF Survey</h1>
                <span class="header-badge">WARDRIVING ANALYZER</span>
            </div>
    ...
    <div class="modal-overlay" id="settings-modal" onclick="closeSettingsFromBackdrop(event)">
        <div class="modal" onclick="event.stopPropagation()">
            ...
            <div style="margin-top: 14px;">
                ...
                <div id="profile-list" style="max-height: 180px; overflow: auto; border: 1px solid var(--border-color); border-radius: 10px; padding: 10px;"><\/div>
...
// ------------------- Layer helpers -------------------
        ...
        function updateMarkers() {
            ...
            // Fit bounds if we have markers (only when no single selection)
            if (!selectedAP && apsWithGps.length > 0 && !showOnlySelected) {
